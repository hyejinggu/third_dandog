...
const Payment = () => {
    ...
    const quantity = location.state.item_quantity;
                        ...
                        <tbody>
                            {selectedItem.quantity === null && [selectedItem].map((i, index) => {
                                ...
                                return (
                                    <tr key={index}>
                                        <td>
                                            <h3 className={styles.name}>{i.item_name}</h3>
                                        </td>
                                        <td>
                                            <span className={styles.quantity}>수량 : {i.quantity}개</span>
                                        </td>
                                        <td>
                                            <ul>
                                                <li>
                                                    <span className={styles.sale_info}>{i.item_discount_rate}%</span>
                                                    <span className={styles.normal_pr}>{i.item_price.toLocaleString("ko")}원</span>
